...
module.exports = function(config, app){
	...
	app.get('/concur/api/reports', function(req, res) {
        logger.debug(config.concur_api_url + config.concur_reports_url);
        let options = {
            method: 'GET',
        ...
        app.get('/concur/api/approvals', function (req, res) {
            logger.debug(config.concur_api_url + config.concur_approvals_url);
            let options = {
                method: 'GET',
            ...
            app.get('/concur/api/trips', function (req, res) {
                logger.debug(config.concur_api_url + config.concur_trips_url);
                let options = {
                    method: 'GET',
